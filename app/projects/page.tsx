...
const projects = [
  {
    id: 1,
    title: "Desenvolvimento App Mobile E-commerce",
    client: "TechCorp Solutions",
    description: "Desenvolvimento de aplicativo mobile para e-commerce com React Native",
    budget: 15000,
    duration: "3 meses",
    status: "Em Andamento",
    priority: "Alta",
    ...
    mentors: [
      { name: "Ana Silva", role: "Frontend Lead" },
      { name: "João Oliveira", role: "Backend Dev" },
      { name: "Carlos Santos", role: "DevOps" },
    ],
  ...
  {
    id: 3,
    title: "Treinamento Corporativo React",
    client: "EduTech Ltda",
    description: "Programa de treinamento em React para equipe de 20 desenvolvedores",
    budget: 12000,
    duration: "8 semanas",
    status: "Concluído",
    priority: "Baixa",
    skills: ["React", "JavaScript", "TypeScript", "Testing"],
    mentors: [
      { name: "Ana Silva", role: "Instrutor Principal" },
      { name: "Maria Costa", role: "UX Consultant" },
    ],
  ...
  },
  {
    ...
    description: "Desenvolvimento de dashboard para análise de big data com Python e ML",
    budget: 22000,
    duration: "4 meses",
    status: "Planejamento",
    priority: "Alta",
    skills: ["Python", "Machine Learning", "PostgreSQL", "React"],
    mentors: [],
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-green-600">R$ {project.budget.toLocaleString()}</div>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    {project.mentors.length} mentores
                  </div>
                  <div className="flex items-center text-sm text-gray-600">
                  ...
                  <div className="flex items-center space-x-3">
                    {project.mentors.length > 0 ? (
                      <>
                        ...
                        <span className="text-sm text-gray-500">{project.mentors.map((m) => m.name).join(", ")}</span>
                      </>
                    ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl font-bold text-green-600">
                  R$ {projects.reduce((acc, p) => acc + p.budget, 0).toLocaleString()}
                </div>
